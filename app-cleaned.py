# ARCHIVED: Original Flask application - moved to Cloudflare Functions
# This file is kept for reference only and should not be deployed
# The actual API endpoints are now in the /functions directory
...
# Environment variables for API keys (REMOVED HARDCODED KEYS FOR SECURITY)
# Set these in your environment or use a .env file
openai.api_key = os.getenv("OPENAI_API_KEY")

# === Twitter API Setup ===
auth = tweepy.OAuth1UserHandler(
    os.getenv("TWITTER_API_KEY"),      # API Key
    os.getenv("TWITTER_API_SECRET"),   # API Secret
    os.getenv("TWITTER_ACCESS_TOKEN"), # Access Token
    os.getenv("TWITTER_ACCESS_SECRET") # Access Secret
)
